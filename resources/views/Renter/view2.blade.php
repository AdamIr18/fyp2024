...
<html>
<head>
    <title>View vehicle renter</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="card border mt-3">
        <div class="card-body">
            <h4>Verification Process (Vehicle Renter Status Updates)</h4>
            <hr>
            <div class="row">
                <div class="col-md-5">
                    <form action="{{ route('users.updateStatus', ['id' => $user->id]) }}" method="POST">
                        ...
                        <label>Update Vehicle Renter Status</label>
                ...
                <div class="col-md-7">
                    <br/>
                    <h4 class="mt-3">Current Order Status: <span class="text-uppercase">{{ $user->status_message ?: 'in progress' }}</span></h4>
